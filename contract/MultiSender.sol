...
contract MultiSender is IAcceptTokensTransferCallback {
    ...
    uint128 private transferNumber = 500;
    ...
    function multiTransfer(address[] recipients, uint128[] amounts, address remainingGasTo, address walletAddress, address tokenRoot) external {
        ...
        require(msgValue >= amounts.length * transferGas, 1008, "not sufficient gas!");
    ...
    */
    ...
    function getDeposits() external onlyOwner returns (mapping(address => mapping(address => uint128))) {
        return deposits;
    }
