    ...
    <q-page-container class="bodyColor" style="min-width:450px">
      <div class="full-width">
        <q-toolbar style="height:64px;">
          ...
          <q-space/>
          <q-btn v-if="!isLogin" class="btn-secondary" @click="login()"><span class="text-capitalize">Connect</span>&nbsp;<span class="text-lowercase">to a wallet</span></q-btn>
  ...
  data () {
    return {
      ...
      menu2List: [
        ...
        { label: 'EVER Scan', path: 'https://everscan.io/' },
